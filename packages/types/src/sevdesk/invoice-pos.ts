...
export const SevdeskInvoicePosResponseSchema = z.object({
	...
	positionNumber: z.coerce.number().int().nullable().optional(),
	priceNet: z.coerce.number().nullable().optional(),
	priceGross: z.coerce.number().nullable().optional(),
	priceTax: z.coerce.number().nullable().optional(),
	sumDiscount: z.coerce.number().nullable().optional(),
	sumNetAccounting: z.coerce.number().nullable().optional(),
	sumTaxAccounting: z.coerce.number().nullable().optional(),
	sumGrossAccounting: z.coerce.number().nullable().optional(),
});
